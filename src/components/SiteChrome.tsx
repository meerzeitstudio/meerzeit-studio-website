  ...
  return (
    <footer className="py-16 px-6 bg-[color:var(--graphite)] text-[color:var(--ivory)]/70 text-sm">
      <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-10 text-center md:text-left">
        <div className="flex flex-col items-center md:items-start gap-3">
          ...
          <div>
            ...
            <p className="font-script text-sm text-[color:var(--ivory)]/60 mt-0.5">— Creative Events —</p>
          </div>
        </div>
      ...
      <div className="text-center mt-12 text-[color:var(--ivory)]/50 flex flex-col sm:flex-row gap-2 sm:gap-6 items-center justify-center">
        ...
        <Link to="/datenschutz" className="hover:text-[color:var(--ivory)] transition">Datenschutz</Link>
      </div>
    </footer>
  );
}

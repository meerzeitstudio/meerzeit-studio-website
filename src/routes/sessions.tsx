...
export const Route = createFileRoute("/sessions")({
  head: () => ({
    meta: [
      { title: "Unsere Events – Meerzeit Studio" },
      {
        name: "description",
        content:
...
const sessions = [
  {
    title: "Malen am Meer",
    img: sMeer,
    text: "Die Wellen als Taktgeberin. Salzige Luft, weiche Farben, ein Pinsel in deiner Hand – und der Horizont, der alles weit macht. Eine Event draußen, wenn das Wetter es erlaubt – sonst mit Meeresrauschen im Raum.",
    mood: "weit · klar · frei",
  },
  {
  ...
  },
  {
    title: "Paint & Beats",
    img: sBeats,
    text: "Musik, die durch dich hindurch geht. Farbe, die folgt. Eine Event, die sich wie Tanzen anfühlt – nur in Slow Motion. Mit kuratierter Playlist und viel Bewegungsfreiheit.",
